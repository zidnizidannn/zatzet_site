...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark shadow" style="background-color: #1D1C26">
        <div class="container">
            <a class="navbar-brand" href="1index.html">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link text-light active" id="nav" href="1index.html">BERANDA</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light active" id="nav" href="2layanan.html">LAYANAN</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light active" id="nav" href="3kontak.html">KONTAK</a>
                    </li>
                    <li class="nav-item">
